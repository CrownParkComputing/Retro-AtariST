...
class GettingStartedSteps {
  ...
  static GuideStep whatYouNeed() => GuideStep(
        title: 'What an Atari ST needs',
        icon: Icons.help_outline,
        body: <Widget>[
          _p(
            'This app is an Atari ST — a computer from 1985 — running inside '
            'your device, via Hatari. Like the real machine, it needs two '
            'things: the chip that makes it an ST, and something to run.',
          ),
          _point(
            Icons.memory,
            'A TOS ROM',
            'The ST has its operating system in ROM, and nothing boots '
                'without it. TOS is Atari\'s copyright and not included — '
                'you supply your own image, the same as with every other ST '
                'emulator.',
          ),
          _point(
            Icons.videogame_asset_outlined,
            'Games and programs',
            'Disk images (.st, .msa, .dim, .stx, .ipf) and folders of ST '
                'programs both work. Disks belonging to one title are '
  ...
  static GuideStep whereFilesGo() {
      ...
      return GuideStep(
        ...
        body: <Widget>[
          ...
          _point(
            ...
            'Then open the folder named Retro-AtariST. The app creates it on '
                'first run.',
          ),
          _point(
            Icons.looks_3_outlined,
            'Put your files in it',
            'Put your TOS ROM and disk images in it. '
      ...
      return GuideStep(
        ...
        body: <Widget>[
          _p(
            ...
            'disks where they already are.',
          ),
          _point(
            Icons.folder_open,
            'Choose the folder',
            'Pick the folder your TOS ROM and disks live in, or the '
                'folder above them. Everything inside it is included.',
          ),
          _point(
            Icons.rule_folder_outlined,
            'The "All files access" question',
            'The app reads your disks in place rather than copying them '
                '— and Android requires the All files access permission for '
                'that. The wizard opens the system page; switch it on for '
                'Retro-AtariST and come back. Without it, folders on an SD '
                'card list but nothing opens.',
          ),
          _point(
    ...
    return GuideStep(
      ...
      body: <Widget>[
        _p(
          'Choose the folder your TOS ROM and disks live in — anywhere '
